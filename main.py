...
def main(num_users, d, m, L, l_server_num,T, filename='',npzname=''):
    ...
    regret, theta_get= G_server.run(envi, T)
    ...
    if npzname == ' ':
        np.savez('FCLUB_4_12_12', nu= num_users, d=d, L= L,T=T,seed=seed,G_server_regret=regret, run_time= run_time,cluster_num=len(G_server.clusters),theta_exp=theta_get,theta_theo= theta)
    else:
...
if __name__ == '__main__':
    ...
    #main(num_users=30, d=10, m=6, L=5, l_server_num=5, T=10000, filename='ml_30user_d10.npy')
    main(num_users=100, d=10, m=10, L=10, l_server_num=10, T=200000, filename='ml_100user_d10.npy',npzname='beta_0.5_100user_200000round_alpha_1')
