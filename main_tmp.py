...
# G_server = SCLUB.Global_server(L, user_num, userList= userList, d=d,rounds=2**(phase + 1) - 2)
...
# np.savez('1_17_DC_debug_user_10', nu=user_num, d=d, L=L, rounds=2**(phase + 1) - 2, G_server_regret=regret,
#                   cluster_num=len(G_server.clusters))
# np.savez('1_19_DC_debug_user_10_no1', nu=user_num, d=d, L=L, rounds=2**(phase + 1) - 2, seed=seed, G_server_regret=regret, run_time=run_time,
